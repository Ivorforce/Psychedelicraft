...
public class FluidDistillingAlcohol extends FluidDrug implements FluidFermentable, FluidDistillable
{
    ...
    public DistillationInfo distillationInfo;

    public FluidDistillingAlcohol(String fluidName, int fermentationSteps, int distillationSteps, float fermentationAlcohol, float distillationAlcohol, DistillationInfo distillationInfo)
    {
        super(fluidName);
        ...
        this.distillationInfo = distillationInfo;
    }
    ...
    public int fermentationTime(FluidStack stack, boolean openContainer)
    {
        ...
        {
            if (openContainer)
                return distillationInfo.ticksPerFermentation;
        }
    ...
    public int distillationTime(FluidStack stack)
    {
        ...
        if (fermentation < fermentationSteps)
            ...
            return distillationInfo.ticksPerDistillation;
    ...
    public static class DistillationInfo
    {
