...
public class TileEntityDryingTable extends TileEntity implements ISidedInventory
{
    ...
    public void updateEntity()
    {
        ...
        if (ticksAlive % 30 == 5 && !worldObj.isRemote)
        {
            ...
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, Psychedelicraft.blockDryingTable, 1, (int) (dryingProgress * 10000f));
        }
    ...
    public void calculateHeatRatio()
    {
        ...
        this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, Psychedelicraft.blockDryingTable, 2, (int) (heatRatio * 10000f));
    }
